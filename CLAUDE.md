...
- Avoid code duplication - if the same or nearly the same method or UI feature is present elsewhere, ask if it should be moved/refactored to a separate file and have both locations call it, passing in any arguments needed to support both calling contexts.
